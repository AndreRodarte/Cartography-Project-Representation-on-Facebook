...
```{r}
df_clean$NM_MUNICIPIO_NASCIMENTO = stri_trans_general(str = df_clean$NM_MUNICIPIO_NASCIMENTO, id = "Latin-ASCII")   #removing accents
df_clean$NM_MUNICIPIO_NASCIMENTO <- tolower(df_clean$NM_MUNICIPIO_NASCIMENTO) #lower case
