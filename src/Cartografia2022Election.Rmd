...
MGMunicipalities <- readr::read_csv("data/ListMunicipalitiesIBGE.csv",
  col_types = cols(
...
dfExpensesTotal <- readr::read_csv("data/dfCampaignExpenses.csv") %>%
  select(
    SG_UF,
    DS_CARGO,
    NR_CANDIDATO,
