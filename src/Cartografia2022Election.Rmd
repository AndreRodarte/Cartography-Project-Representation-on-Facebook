...
Our sample created a total of 73,159 Facebook posts.
...
IBGE_log$Candidate_Born <- ifelse(IBGE_log$name_muni %in% df_clean$NM_MUNICIPIO_NASCIMENTO, 1, 0)
  IBGE_log$Candidate_Born <- log(IBGE_log$Candidate_Born + 1)
```
...
# model_born <- glm(n ~ Candidate_Born, data = IBGE, family = poisson)
# 
