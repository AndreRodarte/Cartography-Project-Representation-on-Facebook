...
###############################
txt <- readr::read_csv('(CART) (COLLECTTED 4-1-2023) CrowdTangle Historical-Report- Parliamentary Candidates MG - 2022-01-01-UNTIL-2023-01-02.csv') %>% 
...
df <- data.frame(txt$body)

# Perform POS tagging using udpipe
annotated_text <- udpipe_annotate(ud_model, x = df$txt.body)
df_2 <- annotated_text %>% 
  as.data.frame() %>%
...
ambiguous_posts <- rbind(nouns_bandeira, nouns_machado, nouns_luz, nouns_conquista, 
                             nouns_divino, nouns_liberdade, nouns_extrema, nouns_passos)
    
# Values for doc_id to include
amb_posts_include <- c("doc72616", "doc69352", "doc74614", "doc5903", "doc44515", "doc8175", "doc17187",
                           "doc20332", "doc20725", "doc20956", "doc38328", "doc40371", "doc41180", "doc44423", 
                           "doc57135", "doc64866", "doc66183", "doc68223", "doc8175", "doc87806")
